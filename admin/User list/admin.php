...
<div class="topnav">
<a href="../Pending user/admin.php">Pending Users</a>
  <a class="active" href="#home">Users List</a>
        ...
        if ($records->num_rows>0){
            ...
            while ($record = $records->fetch_object()) {
                ...
                <tr>
					...
					<td><a href="delete-script.php?recordId=<?php echo $recordId?>" class="btn btn-danger btn">Delete</a></td> 
